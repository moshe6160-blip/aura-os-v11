exports.handler = async function (event) {
  ...
  return {statusCode:302,multiValueHeaders:{'Set-Cookie':['google_connected=true; Path=/; Max-Age=2592000; Secure; SameSite=Lax',`aura_google_token=${encodeURIComponent(data.access_token)}; Path=/; Max-Age=3500; Secure; SameSite=Lax`]},headers:{Location:'/?google=connected'},body:''};
};
